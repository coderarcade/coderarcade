...
export default function AutoGrid() {
  ...
  return (
    <div className={classes.root}>
      ...
      <Avatar alt="Remy Sharp" src="https://media.licdn.com/dms/image/C4D03AQFwV-_AN6FeTQ/profile-displayphoto-shrink_800_800/0?e=1569456000&v=beta&t=weMbbAVoJPGPrvvLeaykFtpi6MfUm7P5L9loePm46HM" className={classes.avatar} />
      <Avatar alt="Remy Sharp" src="https://media.licdn.com/dms/image/C4E03AQHjCyOiM_I_sg/profile-displayphoto-shrink_200_200/0?e=1569456000&v=beta&t=lktgPQdO2cu2hmPx8qM0ogX8cleifHJGb3mk4Zgevbg" className={classes.avatar} />
    </Grid></Paper>
        </Grid>
        <Grid item xs>
      ...
      <Avatar alt="bootstrap" src="https://cdn.worldvectorlogo.com/logos/bootstrap-4.svg" className={classes.bigAvatar} />
