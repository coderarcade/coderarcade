...
export default function Docs() {
    ...
    return (
        <Container style={{ width: "100%", padding: "5%"}} fluid="true">
            <Grid item xs>
                <Paper className={classes.paper}><h3 style={{ textAlign: "center" }}>Read The Documention</h3><Typography variant="body2">Click on the icons to learn more in depth about each language, library, and or framework to read about what they do! Reading the documention is the best source to learn what each one is all about.
